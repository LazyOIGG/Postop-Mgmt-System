...
from app.api.v1.endpoints import (auth, chat, sessions, kg, stats, tools, multimodal, 
                                 health, health_assessment, profile, checkin, overview, reminder, doctor)
...
api_router.include_router(health_assessment.router, prefix="/health-assessment", tags=["健康评估(多模态)"])
